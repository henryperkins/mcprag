...
def test_vector_embeddings():
    ...
    deployment = os.getenv("AZURE_OPENAI_DEPLOYMENT") or os.getenv("AZURE_OPENAI_EMBEDDING_MODEL")
...
if __name__ == "__main__":
    ...
    if success:
        ...
        print("\nNext steps:")
        print("1. Run 'python3 smart_indexer.py --repo-path /path/to/repo --repo-name name'")
        print("2. The indexer will automatically generate embeddings for each code chunk")

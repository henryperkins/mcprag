...
async def test_repository_filtering():
    ...
    results = await server.search_code_enhanced(
        query="function", repository=None  # Should auto-detect
    )
    ...
    results = await server.search_code_enhanced(
        query="function", repository="example-project"
    )
    ...
    results = await server.search_code_enhanced(query="function", repository="*")
    ...
    results = await server.search_code_enhanced(
        query="class", repository="example-project", language="python"
    )
    ...
    request = {
        ...
        "params": {
            "name": "search_code",
            "arguments": {"query": "import", "repository": "example-project"},
        },
    }

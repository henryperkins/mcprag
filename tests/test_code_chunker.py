...
"""
    ...
    def test_generate_document_id(self):
        ...
        doc_id = self.chunker._generate_document_id(
            "test-repo", "src/main.py", "function", 1
        )
        ...
        doc_id2 = self.chunker._generate_document_id(
            "test-repo", "src/main.py", "function", 1
        )
    ...
    def test_supported_file_extensions(self):
        ...
        unsupported_files = ["readme.md", "config.json", "image.png", "binary.exe"]

        for filename in supported_files:
            assert any(
                filename.endswith(ext) for ext in [".py", ".js", ".ts", ".jsx", ".tsx"]
            )

...
class TestRankingMonitor:
    ...
    def monitor(self):
        ...
        return RankingMonitor(storage=InMemoryStorage())
    ...
    async def test_metrics_calculation(self, monitor):
        ...
        for i in range(10):
            ...
            # Pass empty factors for simple test
        ...
        assert 'implement' in snapshot.click_through_rate
    ...
    async def test_performance_report(self, monitor):
        ...
        snapshot = await monitor.calculate_metrics_snapshot()
        await monitor.storage.store_metrics([snapshot])

![Diagram showing the indexer stages, with Skillset Execution as the third stage of five.](https://learn.microsoft.com/en-us/azure/search/media/cognitive-search-defining-skillset/indexer-stages-skillset.png)
